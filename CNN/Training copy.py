...
class Training:
    ...
    def make_data(self, data_folder, batch_size=64):
    ...
    def train_model(self, train_generator, validation_generator, n_epochs=20):
        ...
        checkpoint = ModelCheckpoint(os.path.join(self.data_folder,'best.hdf5'), monitor='val_loss', save_best_only = True, mode='auto')
...
# folder = os.path.join(PROJECT_PATH, 'static', 'uploads', 'f0ace91f3ea44acdb7ab17196a376f17')
