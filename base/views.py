...
def train_model2(request):
    if request.method == 'POST':
        ...
        flower_classifier = Training(size=128, epochs=epochs, patch_sizes=patch_sizes,test_size=test_size, optimizer=optimizer,num_classes=num_classes,folder_path = new_folder_path,PoolingType=poolingType)
